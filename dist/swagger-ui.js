...
function program3(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "</li>\n    ";
  stack1 = helpers['if'].call(depth0, depth0.signature, {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n    ";
  stack1 = helpers['if'].call(depth0, depth0.sampleJSON, {hash:{},inverse:self.noop,fn:self.program(3, program3, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
...
(function() {
  var BasePathView, ContentTypeView, HeaderView, MainView, OperationView, PRIMITIVES, ParameterContentTypeView, ParameterView, ResourceView, ResponseContentTypeView, SignatureView, StatusCodeView, SwaggerUi, _ref, _ref1, _ref10, _ref11, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  ParameterView = (function(_super) {
    ...
    ParameterView.prototype.render = function() {
      ...
      if (this.model.param.format) {
        modelLabel += ", <span class=\"propFormat\">" + this.model.param.format + "</span>";
      }
      if (this.model.param.pattern) {
      ...
      if (__indexOf.call(PRIMITIVES, type) >= 0) {
        sampleJSON = null;
        signature = null;
      } else {
